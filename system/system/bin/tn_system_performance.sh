...
function tinno_heapandlmk_setup()
{
    ...
    if [ $MemTotal -lt 4194430 ]; then
       AmsCacheProcessForRamBoost="0G|12,1G|12,2G|14,4G|14,8G|14"
    ...
    setprop persist.sys.tinno.dalvik.vm.heaptargetutilization $Heaptargetutilization
    ...
    setprop persist.sys.tinno.lmk.kill_heaviest_task $Lmkkillheaviesttask
    setprop persist.sys.tinno.lmk.downgrade_pressure $Lmkdowngradepressure
    ...
    setprop persist.sys.tinno.lmk.filecache_min_kb $Lmkfilecacheminkb
